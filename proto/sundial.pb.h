...
// uint64 ts = 4;
inline void SundialRequest_ReadRequest::clear_ts() {
  ts_ = PROTOBUF_ULONGLONG(0);
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SundialRequest_ReadRequest::_internal_ts() const {
  return ts_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint64 SundialRequest_ReadRequest::ts() const {
  // @@protoc_insertion_point(field_get:sundial_rpc.SundialRequest.ReadRequest.ts)
  return _internal_ts();
}
inline void SundialRequest_ReadRequest::_internal_set_ts(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  
  ts_ = value;
}
inline void SundialRequest_ReadRequest::set_ts(::PROTOBUF_NAMESPACE_ID::uint64 value) {
  _internal_set_ts(value);
  // @@protoc_insertion_point(field_set:sundial_rpc.SundialRequest.ReadRequest.ts)
}
